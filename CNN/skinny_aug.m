...
layers = [
    ...
    convolution2dLayer(3,60,'Padding',[1 1],'Stride', [1,1]);  % convolution layer with 20, 5x5 filters
    reluLayer();  % ReLU layer
    maxPooling2dLayer(2,'Stride',2); % Max pooling layer
...
%Visualization of activation of filter in Layer1
layer='conv_1';
channel=1:20;
I=deepDreamImage(net1,layer,channel,'PyramidLevels',1,... 
    'Verbose',0);
figure(4)
for i=1:20
    subplot(4,5,i)
